...
components.mdi = {
    selector: '[class*="mdi"]',
    styles: './css/mdi/mdi.css'
};

components.grid = {
    selector: '.container, .container-fluid, .row, [class*="col-"]',
    styles: './css/grid/grid.css'
};

components.block = {
    selector: '.block',
    styles: './css/block/block.css'
};
...
components.box = {
    selector: '.box',
    styles: './css/box/box.css'
};

components.button = {
    selector: '.btn, .btn-group',
    styles: './css/button/button.css'
};

components.divider = {
    selector: '.divider',
    styles: './css/divider/divider.css'
};

components.form = {
    selector: '.form-group, .input-group, .form-check, .custom-control, .form-control',
    styles: './css/form/form.css'
};
...
components.icon = {
    selector: '.icon',
    styles: './css/icon/icon.css'
};

components.imageSvg = {
    selector: '.image-svg',
    styles: './css/image-svg/image-svg.css'
};

components.list = {
    selector: '.list',
    styles: './css/list/list.css'
};

components.media = {
    selector: '.media',
    styles: './css/media/media.css'
};

components.partner = {
    selector: '.partner',
    styles: './css/partner/partner.css'
};

components.post = {
    selector: '.post, .post-modern',
    styles: './css/post/post.css'
};

components.pricing = {
    selector: '.pricing, .pricing-modern',
    styles: './css/pricing/pricing.css'
};
...
components.rights = {
    selector: '.rights',
    styles: './css/rights/rights.css'
};

components.section = {
    selector: 'section',
    styles: './css/section/section.css'
};

components.snackbar = {
    selector: '.snackbar',
    styles: './css/snackbar/snackbar.css'
};

components.table = {
    selector: '.table',
    styles: './css/table/table.css'
};

components.team = {
    selector: '.team, .team-mini',
    styles: './css/team/team.css'
};

components.video = {
    selector: '.video',
    styles: './css/video/video.css'
};

components.accordion = {
    selector: '.accordion',
    styles: './css/accordion/accordion.css',
    script: [
...
components.animate = {
    ...
    styles: './css/animate/animate.css',
    script: './js/current-device/current-device.min.js',
    init: function(nodes) {
...
components.countdown = {
    ...
    styles: './css/countdown/countdown.css',
    script: [
...
components.counter = {
    ...
    styles: './css/counter/counter.css',
    script: './js/counter/counter.min.js',
    init: function(nodes) {
        let observer = new IntersectionObserver(function(entries, observer) {
            entries.forEach(function(entry) {
                let node = entry.target;
...
components.fullpage = {
    selector: '.fullpage',
    styles: './css/fullpage/fullpage.css',
    script: [
        './components/jquery/jquery.min.js',
...
components.imageHover = {
    ...
    styles: './css/image-hover/image-hover.css',
    script: [
...
components.lightgallery = {
    ...
    styles: './css/lightgallery/lightgallery.css',
    script: [
        './components/jquery/jquery.min.js',
...
components.multiswitch = {
    ...
    styles: './css/multiswitch/multiswitch.css',
    script: [
        './components/current-device/current-device.min.js',
        './components/multiswitch/multiswitch.min.js'
    ],
...
components.owl = {
    ...
    styles: './css/owl-carousel/owl.carousel.css',
    script: [
        './components/jquery/jquery.min.js',
...
components.rdNavbar = {
    selector: '.rd-navbar',
    styles: './css/rd-navbar/rd-navbar.css',
    script: [
        './components/jquery/jquery.min.js',
        './components/util/util.min.js',
        './components/current-device/current-device.min.js',
...
components.tooltip = {
    ...
    styles: './css/tooltip/tooltip.css',
    script: [
        './components/jquery/jquery.min.js',
        './components/bootstrap/js/popper.min.js',
        './components/bootstrap/js/bootstrap.min.js'
...
components.toTop = {
    selector: 'html',
    styles: './css/to-top/to-top.css',
    script: './js/jquery/jquery.min.js',
    init: function() {
        if (!window.xMode) {
